...
티끌 프로젝트는 저축에 대한 경험을 제공하고 올바른 소비와 재무적 안정을 유도하는 목표로 기획된 프로젝트입니다. 이는 기업들의 투자와 생산 축소로 인해 가계 소득이 감소하는 현실에 대응하고자 하는 창의적인 아이디어입니다.
프로젝트의 핵심 목표는 개인들이 자신의 역량에 맞게 저축을 할 수 있도록 유도하고, 이를 통해 저축에 대한 경험을 제공하는 것입니다. 이를 위해 다양한 방법과 도구를 활용하여 개인들이 저축을 계획하고 추진하는 데 도움을 주고자 기획하였습니다
